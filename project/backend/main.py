...
async def get_financial_summary(
    ...
    # Mock monthly data (in production, calculate from actual data)
    monthly_data = [
        MonthlyData(month="Jan", income=4000, expenses=2400),
        MonthlyData(month="Feb", income=3500, expenses=2200),
        MonthlyData(month="Mar", income=5000, expenses=3100),
        MonthlyData(month="Apr", income=4200, expenses=2800),
        MonthlyData(month="May", income=4800, expenses=3300),
        MonthlyData(month="Jun", income=5500, expenses=3000),
    ]
